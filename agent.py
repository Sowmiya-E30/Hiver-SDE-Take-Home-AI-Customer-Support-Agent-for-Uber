...
def detect_signals(message):
    ...
    if any(word in text for word in [
        ...
        signals.append("FARE_CHARGED_WRONG")
    ...
    if any(word in text for word in [
        ...
        "cancellation charge",
        "cancel fee",
        "charged for cancelling"
    ]):
        signals.append("CANCELLATION_FEE")
    ...
    if any(word in text for word in [
        ...
        signals.append("UBER_EATS_ORDER")
    ...
    if any(word in text for word in [
        ...
        signals.append("LOGIN_ACCOUNT_ACCESS")
    ...
    if any(word in text for word in [
        ...
        signals.append("SUPPORT_CONTACT")
